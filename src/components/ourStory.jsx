    ...
    return (
        <>
            ...
            <div className="flex w-full justify-center bg-[#cdaf8c]">
                <h2 className="text-5xl 2xl:text-6xl bg-white w-[400px] text-center italic">ABOUT FNS</h2>
            </div>
            <div className="w-full h-4 bg-black"></div>
            ...
            <div className="w-full bg-white flex flex-col items-center">
                <div className="w-[80%] flex flex-col items-center bg-[#cdaf8c]">

                    <div className="">
                        <h3 className="text-black text-xl">The Full Story</h3>
                    ...
                    <div>
                        <h2 className="text-5xl text-black italic font-bold mb-2">Mission</h2>
                        <p className="w-1/2 text-black font-semibold">
            ...
            <div className="w-full z-20">
                ...
                <div className="flex flex-col items-center bg-white">
                    <div className="flex flex-col items-center bg-[#cdaf8c] w-[80%]">
                        ...
                        <p className="w-1/2 text-black text-center mb-10">
                            The FNS company culture derives from the determination and will power to replenish the
                            body by taking a break, but never completely stepping away from the ultimate end goal.
                        </p>
                        <div className="grid w-full mt-16 h-[500px]">
                        ...
                        <p className="w-1/2 text-black  text-center mb-20">
