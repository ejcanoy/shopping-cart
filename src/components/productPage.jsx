...
import FatNapzCarousel from "./fatNapzCarousel";
...
function ProductPage() {
    ...
    if (productData) {
        ...
        console.log(productData.prevPage);
                        ...
                        <div>
                            ...
                            <form action="">
                                <fieldset>
                                    ...
                                    <div>
                                        <select className="w-24 text-center border-2 border-black" name="" id="size">
                                ...
                                <fieldset className="pt-5"><button className="w-40 h-10 bg-[#cdaf8c] text-black  ease-in-out delay-150 duration-150 hover:bg-black hover:text-[#cdaf8c]" type="submit">Add to Cart</button></fieldset>
                            </form>
                            <div className="pt-10">
